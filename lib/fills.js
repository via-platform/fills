...
module.exports = class Fills {
    ...
    constructor(){
        ...
        this.columns = [
            ...
            },
            {
                ...
                title: 'Amount',
                default: true,
                accessor: o => o.amount ? `${o.amount.toFixed(o.market.precision.amount)} ${o.market.base}` : '-'
            },
            {
                name: 'price',
                title: 'Price',
    ...
    render(){
        const fills = via.orders.fills().sort((a, b) => b.date - a.date);

        return (
            <div className='fills panel-body'>
